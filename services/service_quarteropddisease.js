...
app.service('quarteropddiseaseService', function ($http, HostConfigFactory) {

    var serverConfig = HostConfigFactory.getHostConfigServer();
    var clientConfig = HostConfigFactory.getHostConfigClient();

    this.get = function (facilityType, successCallback, errorCallback) {
        $http({
            method: 'GET',
            url: serverConfig + 'api/EthioHIMS_QuarterOPDDiseaseView4?facilityType=' + facilityType
