...
'use strict';
app.controller('monthlyopddiseaseController', function ($scope, quarteropddiseaseService, ValueService, LanguageFactory) {
    $scope.title = {};
    $scope.status = {};
    $scope.status_class = {};
    $scope.dataEntry = {};
    ...
    $scope.getLanguageLabel = function (lang, className) {
		...
		.then(function (data) {
		    ...
		    $scope.title = $scope.dataEntry['monthlyOpdDisease'];
    ...
    $scope.loadData = function (locationId) {
        ...
        ValueService.getHmisData($scope.selectedYear, 0, 0, monthIndex, 8, temphierarchy[0].HMISCode, function (response) {
